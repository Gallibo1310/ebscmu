...
@section('content')
    <div class="login-right">
        <div class="login-right-wrap">
            ...
            <form action="{{ route('insregister') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label>Username <span class="login-danger">*</span></label>
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="username">
                ...
                <input type="hidden" name="role_name" value="Instructor">
                <input type="hidden" name="role_type" value="Cleared">
                <!--
