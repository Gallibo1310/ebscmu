                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select" name="status">
                                                ...
                                                <option value="With Accountability" {{ $users->status == 'With Accountability' ? 'selected' : '' }}>With Accountability</option>
                                                <option value="Cleared" {{ $users->status == 'Cleared' ? 'selected' : '' }}>Cleared</option>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select" name="role_name">
                                                ...
                                                <option value="Teachers" {{ $users->role_name == 'Instructors' ? 'selected' : '' }}>Teachers</option>
